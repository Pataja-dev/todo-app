...
const Home = () => {
  ...
  const removeTask = (taskToRemove: number) => {
    const updatedTasks = tasks.filter((_,i) => i !== taskToRemove);
  ...
  return (
    <div className='pt-52 max-h-5'>
      <div className="grid-cols-6 mb-10">
        <form className="sm:max-w-2xl mx-auto flex max-w-2xl ">
